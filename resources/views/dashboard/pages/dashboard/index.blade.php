                            ...
                            <div class="dash-info-widget mt-4 mt-lg-0 py-4 px-3 rounded">
                                ...
                                <div class="media dash-main-border pb-2 mt-2">
                                    ...
                                    <div class="media-body ps-3">
                                        ...
                                        <p class="text-muted">Earning <a href="#" class="text-primary">Withdraw <i
                                ...
                                <div class="media mt-4">
                                    ...
                                    <div class="media-body ps-3">
                                        ...
                                        <p class="text-muted mb-0">To Online <a href="#" class="text-primary">View <i
                                                    class="mdi mdi-arrow-right"></i></a></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <div class="progress mt-3" style="height: 4px;">
                                    <div class="progress-bar progress-bar bg-primary" role="progressbar" style="width: 70%"
                    ...
                    <ul class="list-unstyled activity-wid mb-0">
                        ...
                        <li class="activity-list activity-border">
                            <div class="activity-icon avatar-sm">
                                ...
                                <img src="/assets/dashboard/images/users/avatar-7.jpg" class="avatar-sm rounded-circle"
                                    alt="">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mt-4 mt-sm-0">
                                    ...
                                    <div id="list-chart-1" class="apex-charts" dir="ltr">
                                    </div>
                            ...
                            <div class="col-md-6 dash-goal">
                                ...
                                <div class="mt-4 mt-sm-0">
                                    ...
                                    <div id="list-chart-2" class="apex-charts" dir="ltr">
                                    </div>
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                <div class="row align-items-center mb-5">
                                    <div class="col-md-4">
                                        <img src="/assets/dashboard/images/product/img-3.png" class="img-fluid me-3"
                                            alt="">
                                    </div>
                            ...
                            <div class="carousel-item">
                                <div class="row align-items-center mb-5">
                                    <div class="col-md-4">
                                        <img src="/assets/dashboard/images/product/img-5.png" class="img-fluid me-3"
                                            alt="">
                                    </div>
                                    <div class="col-md-7 offset-md-1">
                            ...
                            <div class="carousel-item">
                                <div class="row align-items-center mb-5">
                                    <div class="col-md-4">
                                        <img src="/assets/dashboard/images/product/img-1.png" class="img-fluid me-3"
                                            alt="">
                                    </div>
                                    <div class="col-md-7 offset-md-1">
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>#2356</td>
                                    <td><img src="/assets/dashboard/images/product/img-7.png" width="42"
                                            class="me-3" alt="">Green
                                        Chair</td>
                                ...
                                <tr>
                                    <td>#2564</td>
                                    <td><img src="/assets/dashboard/images/product/img-8.png" width="42"
                                            class="me-3" alt="">Office
                                        Chair</td>
                                    <td>Alfred Gordon</td>
                                    <td>$242.00</td>
                                    <td>54</td>
                                ...
                                <tr>
                                    <td>#2125</td>
                                    <td><img src="/assets/dashboard/images/product/img-10.png" width="42"
                                            class="me-3" alt="">Gray
                                        Chair</td>
                                    <td>Keena Reyes</td>
                                    <td>$320.00</td>
                                ...
                                <tr>
                                    <td>#8587</td>
                                    <td><img src="/assets/dashboard/images/product/img-11.png" width="42"
                                            class="me-3" alt="">Steel
                                        Chair</td>
                                ...
                                <tr>
                                    <td>#2354</td>
                                    <td><img src="/assets/dashboard/images/product/img-12.png" width="42"
                                            class="me-3" alt="">Home
                                        Chair</td>
                                    <td>Joann Wiliams</td>
                                    <td>$320.00</td>
